...
- schedule slot allocation with time budget enforcement
- conflict detection for overlapping tasks (warning mode)
- recurring task rollover for daily/weekly tasks via `Task.mark_complete()`
